...
type Service interface {
	...
	Search(ctx context.Context, userID string, query string, opts *SearchOptions) ([]*Memory, error)

	// HybridSearch performs hybrid search (semantic + keyword)
	HybridSearch(ctx context.Context, userID string, query string, keywords []string, opts *SearchOptions) ([]*Memory, error)

	// GetMemories retrieves all memories for a user
	GetMemories(ctx context.Context, userID string, limit int) ([]*Memory, error)
...
// Search performs semantic memory search
func (s *MemoryService) Search(ctx context.Context, userID string, query string, opts *SearchOptions) ([]*Memory, error) {
	if opts == nil {
		opts = &SearchOptions{
			TopK:     s.config.TopK,
...
// HybridSearch performs hybrid search (semantic + keyword)
func (s *MemoryService) HybridSearch(ctx context.Context, userID string, query string, keywords []string, opts *SearchOptions) ([]*Memory, error) {
	if opts == nil {
		opts = &SearchOptions{
			TopK:     s.config.TopK,
			MinScore: s.config.MinScore,
...
func (s *MemoryService) filterByKeywords(memories []*Memory, keywords []string) []*Memory {
	var filtered []*Memory
...
// GetMemories retrieves all memories for a user
func (s *MemoryService) GetMemories(ctx context.Context, userID string, limit int) ([]*Memory, error) {
